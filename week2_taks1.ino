...
void loop() {
  ...
  delay(500);
  //##################################################################
  // The second serial band
  /* Get new sensor events with the readings */
  /* Print out the values */
  Serial3.print("Acceleration X: ");
  Serial3.print(a.acceleration.x);
  Serial3.print(", Y: ");
  Serial3.print(a.acceleration.y);
  Serial3.print(", Z: ");
  Serial3.print(a.acceleration.z);
  Serial3.println(" m/s^2");

  Serial3.print("Rotation X: ");
  Serial3.print((g.gyro.x)*180/PI);
  Serial3.print(", Y: ");
  Serial3.print((g.gyro.y)*180/PI);
  Serial3.print(", Z: ");
  Serial3.print((g.gyro.z)*180/PI);
